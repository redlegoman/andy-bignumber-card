...
window.customCards.push({
  type: 'andy-bignumber-card',
  name: 'Andy Big number card',
  preview: false,
  description: 'Andy : A simple card to display big numbers for sensors. It also supports severity levels as background.'
});
